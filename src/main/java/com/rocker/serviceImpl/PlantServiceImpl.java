...
public class PlantServiceImpl implements PlantService{
	...
	public Plant updatePlant(Plant plant) throws PlantException {
		...
		check.setDifficultyLevel(uv.checker( plant.getDifficultyLevel() ) ? plant.getDifficultyLevel() : check.getDifficultyLevel() );
		check.setMedicinalOrCulinaryUse(uv.checker( plant.getMedicinalOrCulinaryUse() ) ? plant.getMedicinalOrCulinaryUse() : check.getMedicinalOrCulinaryUse() );
		check.setPlantCost(uv.checker( plant.getPlantCost() ) ? plant.getPlantCost() : check.getPlantCost() );	
		check.setPlantDescription(uv.checker( plant.getPlantDescription() ) ? plant.getPlantDescription() : check.getPlantDescription() );
